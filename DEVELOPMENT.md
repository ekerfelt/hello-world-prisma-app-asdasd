...
```bash
git remote add encore encore://hello-world-prisma-app-km3i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/hello-world-prisma-app-km3i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/hello-world-prisma-app-km3i/settings/integrations/github)
