 ...
 */
import { createUser as api_hello_create_user_createUser } from "~backend/hello/create_user";
import { getUser as api_hello_get_user_getUser } from "~backend/hello/get_user";
import { listUsers as api_hello_list_users_listUsers } from "~backend/hello/list_users";
...
export namespace hello {
    ...
    export class ServiceClient {
         ...
         * Creates a new user.
         */
        public async createUser(params: RequestType<typeof api_hello_create_user_createUser>): Promise<ResponseType<typeof api_hello_create_user_createUser>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/users`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_hello_create_user_createUser>
        }

        /**
         * Retrieves a user by ID.
         */
        public async getUser(params: { id: number }): Promise<ResponseType<typeof api_hello_get_user_getUser>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/users/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_hello_get_user_getUser>
        }

        /**
         * Retrieves all users, ordered by creation date (latest first).
         */
        public async listUsers(): Promise<ResponseType<typeof api_hello_list_users_listUsers>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/users`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_hello_list_users_listUsers>
        }
    }
}
